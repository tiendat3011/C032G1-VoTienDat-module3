package controller.furama_service;

import model.service_furama.Service;
import service.service_furama.ServiceFuramaService;
import service.service_furama.impl.ServiceFuramaServiceImpl;
...
public class ServiceFuramaServlet extends HttpServlet {
    ...
    private void showFormCreate(HttpServletRequest request, HttpServletResponse response) {
        try {
            request.getRequestDispatcher("furama_service/create-service.jsp").forward(request, response);
    ...
    private void showServiceList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.getRequestDispatcher("furama_service/service.jsp").forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
